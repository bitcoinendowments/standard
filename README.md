...
That changed when James David Spivey sent me his essay making the case for Bitcoin native philanthropy, and we met in the summer of 2026. His foundation, Sats for Change Foundation ([satsforchange.org](https://satsforchange.org)), a Delaware nonstock nonprofit corporation, was working to build native Bitcoin endowments and needed a framework an endowment could be built and audited against. We had been thinking along the same lines about many of the same problems, but there was no framework or standard I could hand them, so I wrote one. The conversations that followed shaped what this document had to answer, and their questions continue to sharpen it as it evolves.

This is a passion project, offered as an option rather than a requirement, to them and to anyone else. They did not author this text, do not steward it, and do not endorse it. Naming them records what prompted the work and nothing more. Nothing here is their statement, and nothing here describes their deployment.
