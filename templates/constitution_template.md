...
>
> **How to use this template.** Replace every value in angle brackets, such as `<ORGANIZATION NAME>`. Read the note under each section before choosing, because most of these are trades rather than settings. Delete the notes before adopting.
>
...
7.4 Reconciliation of the published record is performed by `<PARTY>`, who is neither an administrator nor a guardian. This clause is optional. Delete it if no independent reconciler is appointed.
